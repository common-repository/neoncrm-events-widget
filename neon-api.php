...
class Neon 
{
  ...
  public function go($request) {
    if (isset($request['method']) && isset($request['userSessionId']) ) {
      $str = null;
      if (isset($request['parameters'])) {
        $str = http_build_query($request['parameters']);
        }
      $parameters = 'responseType=json&userSessionId=' . $request['userSessionId'] . '&' . $str;
      $build = array();
  ...
  public function search($request) {
    ...
    if (isset($request['method']) && isset($request['userSessionId']) ) {
      ...
      $addon = 'responseType=json&userSessionId=' . $request['userSessionId'];
